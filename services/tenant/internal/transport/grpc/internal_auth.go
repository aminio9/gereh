...
const onboardingServicePrefix = "/gereh.tenant.v1.TenantOnboardingService/"

// InternalAuthConfig configures workload identity for the internal
// onboarding service.
...
// TenantOnboardingService. All other methods pass through unchanged.
